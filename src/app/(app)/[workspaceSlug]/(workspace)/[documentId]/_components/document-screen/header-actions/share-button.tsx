...
import { OPEN_SHARE_EVENT } from '@/app/(app)/[workspaceSlug]/_components/workspace-shortcuts-provider';
    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <Tabs defaultValue="publish" className="gap-0">
          <TabsList variant="line" className="h-auto w-full rounded-none border-b justify-start px-3">
