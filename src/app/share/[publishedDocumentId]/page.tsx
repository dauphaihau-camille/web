          ...
          return (
            <Fragment key={item.id || `${item.title}-${index}`}>
              ...
              <BreadcrumbItem className="min-w-0">
                {isCurrent
                  ? (
                    <BreadcrumbPage className={cn(breadcrumbLabelClassName, 'max-w-[8rem] py-1 sm:max-w-[10rem] lg:max-w-[12rem]')}>
                      {item.title}
                    </BreadcrumbPage>
                  )
                  : (
                    <BreadcrumbLink
                      ...
                      className={cn(breadcrumbLabelClassName, 'hover:bg-accent hover:text-foreground')}
                    >
                      {item.title}
                    </BreadcrumbLink>
                  )}
