...
const authCopy = {
  login: {
    title: 'Log in',
    description: 'Enter your email and we\'ll send you a code to continue in Camille.',
    alternateCtaLabel: 'Sign up',
    alternateCtaText: 'New user?',
  },
  signup: {
    title: 'Create your account',
    description: 'Enter your details and we\'ll send you a code to get started in Camille.',
...
export function AuthForm({ mode }: { mode: AuthFormMode }) {
  ...
  const alternateHref = mode === 'login'
